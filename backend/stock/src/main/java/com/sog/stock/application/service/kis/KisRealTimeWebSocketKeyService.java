...
public class KisRealTimeWebSocketKeyService {
    ...
    private static final String REDIS_KEY_NAME = "kisRealTimeKey";
    private static final int REDIS_KEY_EXPIRATION_HOURS = 24;

    private static final String CRON_EXPRESSION_MIDNIGHT = "0 0 0 * * *"; // 매일 자정
    ...
    public String getRealTimeWebSocketKey() {
        String key = redisService.getValue(REDIS_KEY_NAME);
    ...
    public void requestNewWebSocketKey() {
        ...
        try {
            ...
            if (approvalKey != null) {
                redisService.setValues("kisRealTimeKey", approvalKey,
